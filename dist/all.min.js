...
var y2App=angular.module("y2Studio",["ui.router"]);y2App.run(["$rootScope","$location","$window",function(t,e,r){t.$on("$stateChangeSuccess",function(t){r.ga&&r.ga("send","pageview",{page:e.path()})})}]),y2App.config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("main",{url:"/",template:"<y2-logo></y2-logo><y2-footer></y2-footer>"}).state("work",{url:"/work",templateUrl:"views/work.html"}).state("about",{url:"/about",templateUrl:"views/about.html"}).state("contact",{url:"/contact",templateUrl:"views/contact.html"})}]),y2App.controller("WorkController",["$scope","$timeout",function(t,e){var r=this;r.designs=[];var n=function(t,e){r.designs.push({alt:t,small:"img/750/"+t+".png",big:"img/1200/"+t+".png",fullProjectUrl:e})};r.pickDesign=function(t){r.picked==t&&(t=null),r.picked=t},n("brod","https://www.behance.net/gallery/19665489/branding-broed"),n("biscuit","https://www.behance.net/gallery/24550411/rebranding-webdesign-biscuit-projekt"),n("architecture","https://www.behance.net/gallery/24550411/rebranding-webdesign-biscuit-projekt"),n("jorn","https://www.behance.net/gallery/24852767/JORN-visual-identity"),n("carpenter","https://www.behance.net/gallery/24447469/visual-identity-carpenter"),n("biotanical","https://www.behance.net/gallery/26065139/-B-I-O-T-A-N-I-C-A-L"),n("dorteRask","https://www.behance.net/gallery/24583411/branding-makeup-artist"),n("czarnaKawka","https://www.behance.net/gallery/19665803/branding-czarna-kawka"),e(function(){picturefill()},0)}]),y2App.controller("AboutController",["$timeout",function(t){t(function(){picturefill()},0)}]),y2App.directive("y2Logo",function(){return{restrict:"E",template:'<div class="row" style="margin-top: 50px"> <img src="img/logo.png" class="img-responsive center-block img-logo" alt="2Y Logo">     <div class="logo-text text-center"> <p>2Y GRAPHIC DESIGN STUDIO</p> </div></div>'}}),y2App.directive("y2Footer",function(){return{restrict:"E",templateUrl:"views/footer.html"}});