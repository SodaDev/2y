...
var y2App=angular.module("y2Studio",["ui.router"]);y2App.run(["$rootScope","$location","$window",function(e,t,n){e.$on("$stateChangeSuccess",function(e){n.ga&&n.ga("send","pageview",{page:t.path()})})}]),y2App.config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/"),e.state("main",{url:"/",template:"<y2-logo></y2-logo><y2-footer></y2-footer>"}).state("work",{url:"/work",templateUrl:"views/work.html"}).state("about",{url:"/about",templateUrl:"views/about.html"}).state("contact",{url:"/contact",templateUrl:"views/contact.html"})}]),y2App.controller("WorkController",["$scope","$window",function(e,t){var n=this;n.designs=[],n.smallDesigns=[],n.bigDesigns=[],n.createDesign=function(e,t,n){return{alt:e,imgUrl:t,fullProjectUrl:n}};var i=function(e,t,i){n.smallDesigns.push(n.createDesign(e,"img/750/"+e+".png",t)),n.bigDesigns.push(n.createDesign(e,"img/1200/"+e+"_1.png",t)),i||n.bigDesigns.push(n.createDesign(e,"img/1200/"+e+"_2.png",t))};n.pickDesign=function(e){n.picked==e&&(e=null),n.picked=e},i("brod","https://www.behance.net/gallery/19665489/branding-broed"),i("biscuit","https://www.behance.net/gallery/24550411/rebranding-webdesign-biscuit-projekt"),i("jorn","https://www.behance.net/gallery/24852767/JORN-visual-identity"),i("carpenter","https://www.behance.net/gallery/24447469/visual-identity-carpenter"),i("biotanical","https://www.behance.net/gallery/26065139/-B-I-O-T-A-N-I-C-A-L"),i("dorteRask","https://www.behance.net/gallery/24583411/branding-makeup-artist"),i("czarnaKawka","https://www.behance.net/gallery/19665803/branding-czarna-kawka",!0),n.pickDesignSet=function(){t.innerWidth<768?n.designs=n.smallDesigns:n.designs=n.bigDesigns},angular.element(t).bind("resize",function(t){e.$apply(function(){n.pickDesignSet()})}),n.pickDesignSet()}]),y2App.controller("AboutController",["$scope","$window",function(e,t){var n=this;n.aboutImg=null,n.pickAboutImg=function(){t.innerWidth<1200?n.aboutImg="img/750/we.png":n.aboutImg="img/1200/we.png"},angular.element(t).bind("resize",function(t){e.$apply(function(){n.pickAboutImg()})}),n.pickAboutImg()}]),y2App.directive("y2Logo",function(){return{restrict:"E",template:'<div class="row" style="margin-top: 50px"> <img src="img/BANER.svg" class="img-responsive center-block img-logo" alt="2Y Logo">     <div class="logo-text text-center"> <p>2Y GRAPHIC DESIGN STUDIO</p> </div></div>'}}),y2App.directive("y2Footer",function(){return{restrict:"E",templateUrl:"views/footer.html"}});